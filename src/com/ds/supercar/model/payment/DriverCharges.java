...
public class DriverCharges {
	...
	public DriverCharges(int drivercahrgeid, double h_c_p_day, double h_c_p_night, double c_p_day, double c_p_night,
			double c_p_week, double c_p_month, double wait_c_p_min) {
		super();
		this.driverchargeid = drivercahrgeid;
	...
	public int getDrivercahrgeid() {
		return driverchargeid;
	}

	public void setDrivercahrgeid(int drivercahrgeid) {
		this.driverchargeid = drivercahrgeid;
	}
